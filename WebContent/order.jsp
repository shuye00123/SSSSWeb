											...
											<s:iterator value="list1" var="u">
												...
												<s:if test="#z.order_id ==#u.order_id ">
													<s:if test="#j!=#k">
														...
														<tr>
															<td><a href="sDetialGoodsA?id=<s:property value="#u.id" />"><img class="img" src="<s:property value="#u.img" />"></a></td>
															<td><a class="break" href="sDetialGoodsA?id=<s:property value="#u.id" />"><s:property value="#u.chn_name" /><s:property value="#u.eng_name" /><s:property value="#u.code" /></a>
															</td>
